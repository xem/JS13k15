...
60);else if(2==n||3==n){C=[g[3][0],g[1][0],g[0][0],g[3][1],g[1][1],g[4][0],g[0][1],g[2][0],g[3][2],g[4][1],g[0][2],g[2][1],g[1][2]][A];h.rect(0,0,1200,66);h.fill();h.beginPath();h.fillStyle="#fff";2==n&&(h.rect(0,60,4*o,5),h.fill());t(10,45,"Country;Capitol;Place;Country;Capitol;U.S. state;Place;U.S. capitol;Country;U.S. state;Place;U.S. capitol;Capitol".split(";")[A]+": "+C[B][0].toUpperCase(),40,0,"left");t(1190,45,q+"km remaining",40,0,"right");h.strokeStyle="#83864F";h.fillStyle="#95D866";for(i=
0;i<g[3].length;i++)for(j=0;j<g[3][i].length;j++){a=g[3][i][j][1];for(k=0;k<a.length;k+=2)255==a[k]&&(k++,h.closePath(),h.fill(),h.stroke(),h.beginPath()),255==a[k+1]&&(k+=2,h.closePath(),h.fill(),h.stroke(),h.beginPath()),x=4.9*a[k]+0,y=2.35*a[k+1]+65,0==k&&(h.beginPath(),h.moveTo(x,y)),h.lineTo(x,y);h.closePath();h.fill();h.stroke()}2==n&&0==o&&(p=1E4,n=3,o=60,z=1);if(3==n){a=C[B][1];if(0==A||3==A||5==A||8==A||9==A){h.fillStyle="yellow";h.beginPath();for(k=0;k<a.length;k+=2)255==a[k]&&(k++,h.closePath(),
h.fill(),h.stroke(),60==o&&h.isPointInPath(X,Y)&&(p=0,c=[X,Y]),h.beginPath()),x=4.9*a[k]+0,y=2.35*a[k+1]+65,60==o&&(b=m.sqrt(m.pow(x-X,2)+m.pow(y-Y,2)),b<p&&(p=b,c=[x,y])),0==k&&(h.beginPath(),h.moveTo(x,y)),h.lineTo(x,y);h.closePath();h.fill();h.stroke();60==o&&h.isPointInPath(X,Y)&&(p=0,c=[X,Y])}else x=4.9*a[0]+0,y=2.35*a[1]+65,h.fillStyle="yellow",h.beginPath(),h.arc(x,y,10,0,7),h.fill(),60==o&&(p=b=m.sqrt(m.pow(x-X,2)+m.pow(y-Y,2)),c=[x,y]);z||(5<p&&(h.fillStyle="green",h.strokeStyle="green",
h.beginPath(),h.moveTo(c[0],c[1]),h.lineTo(c[0]-1,c[1]),h.lineTo(c[0]-1,c[1]-40),h.lineTo(c[0],c[1]-40),h.lineTo(c[0]+20,c[1]-30),h.lineTo(c[0],c[1]-20),h.stroke(),h.fill(),h.strokeStyle="red",h.lineWidth="2",h.setLineDash([5,5]),h.beginPath(),h.moveTo(X,Y),h.lineTo(c[0],c[1]),h.stroke()),h.setLineDash([0,0]),h.fillStyle="blue",h.strokeStyle="blue",h.beginPath(),h.moveTo(X,Y),h.lineTo(X-1,Y),h.lineTo(X-1,Y-40),h.lineTo(X,Y-40),h.lineTo(X+20,Y-30),h.lineTo(X,Y-20),h.stroke(),h.fill());45==o&&(q-=100>
p?100*~~(p/5):1E3*~~(p/50));45>o&&(z?(t(600,350,"TIME OUT",100,"#000"),t(600,400,"10,000km penalty",50,"#000")):t(600,350,5<p?(100>p?100*~~(p/5):1E3*~~(p/50))+"km away":"PERFECT",100,"#000"));0>q&&(q=0,n=6);0==o&&(n=4,o=5)}}4==n&&(h.fillRect(0,0,1200,650),0==o&&(Y=X=0,B++,n=2,p=5E4,o=300,z=0,1<B&&(B=0,A++,n=1,r+=q,q=2E4,12<A&&(n=6))));o&&o--;setTimeout(w,33)};$.onclick=function(d){0==n?n=1:1==n?(n=2,o=300):2==n&&(X=d.pageX,Y=d.pageY,n=3,o=60)}